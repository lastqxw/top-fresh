...
<template>
	<div class="r-product">
        ...
        <img v-lazy="img" v-if="index == 1" v-for="i in 4" @click="goGoodInfoVC('1234')" :key="i">
        <!--<img v-for="item in imgList" :src="item.imgUrl" v-if="index == 1" @click="goGoodInfoVC(item.id)">-->
				<img v-lazy="img" v-if="index == 2" v-for="i in 4" @click="goGoodInfoVC('1234')" :key="i">
...
<script>
	...
	import img from '../../../../assets/img/组7@2x.png'
  export default {
    mixins:[indexService],
		data() {
			return {
